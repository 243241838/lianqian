                ...
                <table class="layui-table" id="table">
                    ...
                    <tbody>
                        <tr  v-for="(item,index) in list">
                            ...
                            <td>{{item.exceptionsComment.length > 10 ? item.exceptionsComment.substring(0,10) + '...' : item.exceptionsComment}}</td>
...
export default {
    ...
    methods: {
        ...
        getTable (data) {
            ...
            request('/collection/collectionExceptionsList.html', tableDate, (response) => {
                console.log(response.data.data)
                if (response.data.respCode === '000000') {
                    let output = response.data.data;
                    if (output) {
                        this.list = output.collectionExceptionsList; // 数据list
        ...
        order_allocation (data) {
            request('/collection/collectionExceptionsDeal.html', data, (response) => {
